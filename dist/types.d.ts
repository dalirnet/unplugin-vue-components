...
declare type DeclarationOutput = {
    [Key in ComponentResolverObject['type']]: string[];
};
declare type DeclarationTransformer = (declaration: DeclarationOutput) => DeclarationOutput;
